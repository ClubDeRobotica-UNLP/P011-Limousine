...
void setup()
{
  ...
  digitalWrite(LED1, 0);
  digitalWrite(LED2, 0);
  MotoresInitCoso(M1A, M2A);
  Serial.begin(9600);
  ApagarMotoresCoso(M1PWM, M1A, M2PWM, M2A);
}
...
/*----------------------------------------------------------------------------------
    FunciÃ³n para inicializar los Motores
  ----------------------------------------------------------------------------------*/

void MotoresInitCoso(byte M1A, byte M2A)
{
  pinMode(M1A, OUTPUT);
  pinMode(M2A, OUTPUT);
}
...
/*----------------------------------------------------------------------------------
    FunciÃ³n para apagar los Motores con valores absolutos VelM1/2 : (-255; 255)
  ----------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------
    FunciÃ³n para mover los Motores a partir de porcentajes
  -------------------------------------------------------------*/
...
/*-------------------------------------------------------------
    FunciÃ³n para apagar los Motores
  -------------------------------------------------------------*/

void ApagarMotoresCoso(byte M1PWM, byte M1A, byte M2PWM, byte M2A)
{
